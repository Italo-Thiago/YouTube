...
class Program{
  ...
  //public void CopyTo(Ar_destino,a_partir_deste_pos);
  ...
  long qtdeElementoVetor=vetor1.GetLongLength(0);
  ...
  Console.WriteLine("Maior índice do vetor {0}",MaiorIndiceVetor);
  Console.WriteLine("------------------------------------------");
